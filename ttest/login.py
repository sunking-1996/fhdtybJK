...
ses = requests.Session() #session保持回话
ses.proxies = proxies
ses.verify = False
ses.headers = header
...
c.set("fhd_user_info_avatar","https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJiaGdSuKpkrLN4tlrze2OOHwicfS73TJKAScS9toziaicpjWUySrxgickrERnSicVbVtHJSC3Nx2EC5dyA/132")
c.set("fhd_user_info_nick","sunking")
c.set("JSESSIONID","BA0DADE8B8CE9A733961753C52A0A62E.fap1-fhdcommon")
c.set("yunxu_chooseProjectCookieKey","123")
r1.cookies.update(c)
