...
class Test_login(unittest.TestCase):
    ...
    def test_login_002_password_wrong(self):  # 测试用例
        '''反例:密码错参'''
        print("反例:密码错参")
        self.body = {"userAccount":"15167168967",
                    "userPwd":"1234567"} #参数存字典
        self.s = requests.session()
        self.s.verify = False
        request = self.s.post(url=self.url,data=self.body,headers=self.header)
        d   =  request.json()  #解析json
    ...
    def test_login_003_password_null(self):  # 测试用例
        '''反例:密码空参'''
        print("反例:密码空参")
        self.body = {"userAccount":"15167168967",
                    "userPwd":""} #参数存字典
    ...
    def test_login_004_username_wrong(self):  # 测试用例
        '''反例:用户名错参'''
        print("反例:用户名错参")
        self.body = {"userAccount":"1516716",
                    "userPwd":"123456"} #参数存字典
        self.s = requests.session()
        self.s.verify = False
        request = self.s.post(url=self.url,data=self.body,headers=self.header)
    ...
    def test_login_005_username_null(self):  # 测试用例
        '''反例:用户名空参'''
        print("反例:用户名空参")
        self.body = {"userAccount":"",
                    "userPwd":"123456"} #参数存字典
        self.s = requests.session()
        self.s.verify = False
        request = self.s.post(url=self.url,data=self.body,headers=self.header)
    ...
    def test_login_006_all_null(self):  # 测试用例
        '''反例:用户名与密码全为空参'''
        print("反例:用户名与密码全为空参")
        self.body = {"userAccount":"",
                    "userPwd":""} #参数存字典
    ...
    def test_login_007_all_none(self):  # 测试用例
        '''反例:用户名与密码全为None'''
        print("反例:用户名与密码全为None")
        self.body = {"userAccount":None,
                    "userPwd":None} #参数存字典
        self.s = requests.session()
        self.s.verify = False
        request = self.s.post(url=self.url,data=self.body,headers=self.header)
